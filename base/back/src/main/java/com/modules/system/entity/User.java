...
import com.modules.common.validator.Create;
import com.modules.common.validator.FieldRepeatValidator;
import com.modules.common.validator.Update;
...
//	@FieldRepeatValidator(className = "User", field = "pwd", message = "密码重复！")
//	@FieldRepeatValidator(className = "User", field = "pwd", message = "密码重复！",groups={FieldRepeatValidator.class})
	private String pwd;
    /**
     * 昵称
     */
