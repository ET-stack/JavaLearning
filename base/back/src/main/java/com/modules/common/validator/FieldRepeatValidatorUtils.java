package com.modules.common.validator;
...
//        List list = entity.selectPage( new Page<>( 1,1 ), new QueryWrapper().eq( field, fieldValue ) ).getRecords();
        List list = entity.selectList((Wrapper) new QueryWrapper().eq( db_field, fieldValue ));
